import { GoldTitle, GrayTitle } from "@/components/reusables.jsx";
...
export const ROLES = [
  {
    ...
    title: <GrayTitle>Crack interviews with AI practice</GrayTitle>,
    desc: "Stop guessing what interviewers expect. Prept simulates real interview scenarios with an intelligent AI interviewer — helping you practice, improve, and build confidence.",
    perks: [
      "AI-generated role-specific questions (DSA, System Design, HR)",
      "Real-time voice-based interview simulation",
      "Instant AI feedback after every session",
      "Access recordings to review and improve",
      "Practice anytime — no scheduling required",
    ],
  },
  {
    label: "AI Interviewer",
    title: <GoldTitle>Your personal interview coach</GoldTitle>,
    desc: "Prept acts as your always-available interviewer — generating questions, evaluating answers, and guiding you with data-driven insights.",
    perks: [
      "Adaptive questions based on your role and experience",
      "Smart feedback on communication and correctness",
      "Performance tracking with detailed reports",
      "Continuous learning with personalized improvement tips",
    ],
  },
];
